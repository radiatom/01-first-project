...
const ProfileInfo = React.memo((props) => {
    return (
        <div className={s.profileInfo}>
            ...
            <div><h3>My first react site on usual bootstrap :<a href="https://radiatom.github.io/demo-site-react-usual-bootstrap/">https://radiatom.github.io/demo-site-react-usual-bootstrap/</a> </h3></div>
